			...
			<Container className="fontSmall">
				...
				<Row>
					<p className="componentText">
						Designed, Deployed, Maintained office "Work Tracking System" database that monitored all
						incoming/outgoing correspondence and all work assignments and deadlines
					</p>
				</Row>
				<Row>
					<p className="componentText">
						Analyzed aviation safety data to provide insight and predictive modeling to office management
					</p>
				</Row>
				<Row>
					<p className="componentText">
						Oversaw the office Quality Management System as the{' '}
						<a
