			...
			<Container className="fontSmall">
				...
				<Row>
					<p className="componentText">
						Promoted to rank of Sergeant in a team leader position as quickly as allowed by policy (24
						months)
					</p>
				</Row>
				<Row>
				...
				<Row>
					<p className="componentText">Two combat tours, Iraq</p>
				</Row>
				<Row>
					<p className="componentText">
						Participated in{' '}
				...
				<Row>
					<p className="componentText">
						Six month tour, South Korea; vicinity of the{' '}
						<a
							href="https://en.wikipedia.org/wiki/Korean_Demilitarized_Zone"
							target="_blank"
							rel="noreferrer noopener"
						>
				...
				<Row>
					<p className="componentText">Consistently achieved maximum score on physical fitness assessments</p>
				</Row>
			</Container>
		);
	}
